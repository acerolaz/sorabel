...
c'est la responsabilité de `mcp` en amont (`api-gateway` ne fait que router, sans
inspection RBAC). Ce projet suppose que tout appel qu'il reçoit est déjà autorisé.
